...
def upload_to_youtube(video_path, title, description, tags=None, category_id='22'):
    ...
    if tags is None:
        tags = ["fitness", "motivation", "gym", "workout", "mindset", "discipline", "success", "shorts", "reels"]
...
def main():
    ...
    title = "Fitness Motivation Daily"
    description = "Crush your limits and stay disciplined. #shorts #fitness #motivation #gym"
    tags = ["fitness", "motivation", "gym", "workout"]
